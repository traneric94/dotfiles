# Effective Python — full rule detail (124 items)
...
### 22. Prefer enumerate Over range  [2nd,3rd] · medium
...
### 23. Use zip to Process Iterators in Parallel  [2nd,3rd] · high
...
### 24. Avoid else Blocks After for and while Loops  [2nd,3rd] · low
...
### 25. Never Use for Loop Variables After the Loop Ends  [3rd] · high
...
### 26. Be Defensive when Iterating over Arguments  [2nd,3rd] · high
...
### 27. Never Modify Containers While Iterating over Them; Use Copies or Caches Instead  [3rd] · high
...
### 28. Pass Iterators to any and all for Efficient Short-Circuiting Logic  [3rd] · medium
...
### 29. Consider itertools for Working with Iterators and Generators  [2nd,3rd] · medium
...
### 30. Know That Function Arguments Can Be Mutated  [3rd] · high
...
### 31. Return Dedicated Result Objects Instead of Requiring Function Callers to Unpack More Than Three Variables (3rd) / Never Unpack More Than Three Variables When Functions Return Multiple Values (2nd)  [2nd,3rd] · medium
...
### 32. Prefer Raising Exceptions to Returning None  [2nd,3rd] · high
...
### 33. Know How Closures Interact with Variable Scope and nonlocal (3rd) / Know How Closures Interact with Variable Scope (2nd)  [2nd,3rd] · high
...
### 34. Reduce Visual Noise with Variable Positional Arguments  [2nd,3rd] · medium
...
### 35. Provide Optional Behavior with Keyword Arguments  [2nd,3rd] · medium
...
### 36. Use None and Docstrings to Specify Dynamic Default Arguments  [2nd,3rd] · high
...
### 37. Enforce Clarity with Keyword-Only and Positional-Only Arguments  [2nd,3rd] · medium
...
### 38. Define Function Decorators with functools.wraps  [2nd,3rd] · medium
...
### 39. Prefer functools.partial over lambda Expressions for Glue Functions  [3rd] · low
...
### 40. Use Comprehensions Instead of map and filter  [2nd,3rd] · medium
...
### 41. Avoid More Than Two Control Subexpressions in Comprehensions  [2nd,3rd] · medium
...
### 42. Reduce Repetition in Comprehensions with Assignment Expressions  [2nd,3rd] · medium
...
### 43. Consider Generators Instead of Returning Lists  [2nd,3rd] · medium
...
### 44. Consider Generator Expressions for Large List Comprehensions  [2nd,3rd] · medium
...
### 45. Compose Multiple Generators with yield from  [2nd,3rd] · medium
...
### 46. Pass Iterators into Generators as Arguments Instead of Calling the send Method  [2nd,3rd] · high
...
### 47. Manage Iterative State Transitions with a Class Instead of the Generator throw Method  [2nd,3rd] · high
...
### 48. Compose Classes Instead of Nesting Many Levels of Built-in Types  [2nd] · medium
...
### 49. Accept Functions Instead of Classes for Simple Interfaces  [2nd,3rd] · low
...
### 50. Prefer Object-Oriented Polymorphism over Functions with isinstance Checks  [3rd] · high
...
### 51. Consider functools.singledispatch for Functional-Style Programming Instead of Object-Oriented Polymorphism  [3rd] · medium
...
### 52. Prefer dataclasses for Defining Lightweight Classes  [3rd] · medium
...
### 53. Use @classmethod Polymorphism to Construct Objects Generically  [2nd,3rd] · medium
...
### 54. Initialize Parent Classes with super  [2nd,3rd] · high
...
### 55. Consider Composing Functionality with Mix-in Classes  [2nd,3rd] · medium
...
### 56. Prefer Public Attributes over Private Ones  [2nd,3rd] · low
...
### 57. Prefer dataclasses for Creating Immutable Objects  [3rd] · medium
...
### 58. Inherit from collections.abc for Custom Container Types  [2nd,3rd] · medium
...
### 59. Use Plain Attributes Instead of Setter and Getter Methods  [2nd,3rd] · medium
...
### 60. Consider @property Instead of Refactoring Attributes  [2nd,3rd] · medium
...
### 61. Use Descriptors for Reusable @property Methods  [2nd,3rd] · high
...
### 62. Use __getattr__, __getattribute__, and __setattr__ for Lazy Attributes  [2nd,3rd] · high
...
### 63. Validate Subclasses with __init_subclass__  [2nd,3rd] · medium
...
### 64. Register Class Existence with __init_subclass__  [2nd,3rd] · medium
...
### 65. Annotate Class Attributes with __set_name__  [2nd,3rd] · medium
...
### 66. Consider Class Body Definition Order to Establish Relationships Between Attributes  [3rd] · medium
...
### 67. Prefer Class Decorators Over Metaclasses for Composable Class Extensions  [2nd,3rd] · high
...
### 68. Use subprocess to Manage Child Processes  [2nd,3rd] · high
...
### 69. Use Threads for Blocking I/O, Avoid for Parallelism  [2nd,3rd] · high
...
### 70. Use Lock to Prevent Data Races in Threads  [2nd,3rd] · high
...
### 71. Use Queue to Coordinate Work Between Threads  [2nd,3rd] · medium
...
### 72. Know How to Recognize When Concurrency Is Necessary  [2nd,3rd] · medium
...
### 73. Avoid Creating New Thread Instances for On-demand Fan-out  [2nd,3rd] · high
...
### 74. Understand How Using Queue for Concurrency Requires Refactoring  [2nd,3rd] · medium
...
### 75. Consider ThreadPoolExecutor When Threads Are Necessary for Concurrency  [2nd,3rd] · medium
...
### 76. Achieve Highly Concurrent I/O with Coroutines  [2nd,3rd] · high
...
### 77. Know How to Port Threaded I/O to asyncio  [2nd,3rd] · medium
...
### 78. Mix Threads and Coroutines to Ease the Transition to asyncio  [2nd,3rd] · medium
...
### 79. Avoid Blocking the asyncio Event Loop to Maximize Responsiveness (2nd ed.) / Maximize Responsiveness of asyncio Event Loops with async-friendly Worker Threads (3rd ed.)  [2nd,3rd] · high
...
### 80. Consider concurrent.futures for True Parallelism  [2nd,3rd] · medium
...
### 81. Take Advantage of Each Block in try/except/else/finally  [2nd,3rd] · medium
...
### 82. Consider contextlib and with Statements for Reusable try/finally Behavior  [2nd,3rd] · medium
...
### 83. Make pickle Reliable with copyreg (3rd ed.: Make pickle Serialization Maintainable with copyreg)  [2nd,3rd] · high
...
### 84. assert Internal Assumptions and raise Missed Expectations  [3rd] · high
...
### 85. Always Make try Blocks as Short as Possible  [3rd] · medium
...
### 86. Beware of Exception Variables Disappearing  [3rd] · high
...
### 87. Beware of Catching the Exception Class  [3rd] · high
...
### 88. Understand the Difference Between Exception and BaseException  [3rd] · high
...
### 89. Use traceback for Enhanced Exception Reporting  [3rd] · medium
...
### 90. Consider Explicitly Chaining Exceptions to Clarify Tracebacks  [3rd] · medium
...
### 91. Always Pass Resources into Generators and Have Callers Clean Them Up Outside  [3rd] · high
...
### 92. Never Set __debug__ to False  [3rd] · high
...
### 93. Avoid exec and eval Unless You're Building a Developer Tool  [3rd] · high
...
### 94. Profile Before Optimizing  [2nd,3rd] · medium
...
### 95. Consider memoryview and bytearray for Zero-Copy Interactions with bytes  [2nd,3rd] · medium
...
### 96. Optimize Performance-Critical Code Using timeit Microbenchmarks  [3rd] · medium
...
### 97. Know When and How to Replace Python with Another Programming Language  [3rd] · medium
...
### 98. Consider ctypes to Rapidly Integrate with Native Libraries  [3rd] · high
...
### 99. Consider Extension Modules to Maximize Performance and Ergonomics  [3rd] · medium
...
### 100. Lazy-Load Modules with Dynamic Imports to Reduce Startup Time  [3rd] · medium
...
### 101. Sort by Complex Criteria Using the key Parameter  [2nd,2nd (Item 14, Ch.2 Lists and Dictionaries),3rd,3rd (Item 100, Ch.12 Data Structures and Algorithms)] · medium
...
### 102. Use datetime Instead of time for Local Clocks  [2nd,2nd (Item 67, Ch.8 Robustness and Performance),3rd,3rd (Item 105, Ch.12 Data Structures and Algorithms)] · high
...
### 103. Use decimal When Precision Is Paramount  [2nd,2nd (Item 69, Ch.8 Robustness and Performance),3rd,3rd (Item 106, Ch.12 Data Structures and Algorithms)] · high
...
### 104. Prefer deque for Producer-Consumer Queues  [2nd,2nd (Item 71, Ch.8 Robustness and Performance),3rd,3rd (Item 103, Ch.12 Data Structures and Algorithms)] · high
...
### 105. Consider Searching Sorted Sequences with bisect  [2nd,2nd (Item 72, Ch.8 Robustness and Performance),3rd,3rd (Item 102, Ch.12 Data Structures and Algorithms)] · medium
...
### 106. Know How to Use heapq for Priority Queues  [2nd,2nd (Item 73, Ch.8 Robustness and Performance),3rd,3rd (Item 104, Ch.12 Data Structures and Algorithms)] · medium
...
### 107. Use repr Strings for Debugging Output  [2nd] · medium
...
### 108. Verify Related Behaviors in TestCase Subclasses  [2nd,3rd] · medium
...
### 109. Prefer Integration Tests over Unit Tests  [3rd] · high
...
### 110. Isolate Tests from Each Other with setUp, tearDown, setUpModule, and tearDownModule  [2nd,3rd] · high
...
### 111. Use Mocks to Test Code with Complex Dependencies  [2nd,3rd] · high
...
### 112. Encapsulate Dependencies to Facilitate Mocking and Testing  [2nd,3rd] · high
...
### 113. Consider Interactive Debugging with pdb  [2nd,3rd] · medium
...
### 114. Use tracemalloc to Understand Memory Usage and Leaks  [2nd,3rd] · medium
...
### 115. Know Where to Find Community-Built Modules  [2nd,3rd] · medium
...
### 116. Use Virtual Environments for Isolated and Reproducible Dependencies  [2nd,3rd] · high
...
### 117. Write Docstrings for Every Function, Class, and Module  [2nd,3rd] · medium
...
### 118. Use Packages to Organize Modules and Provide Stable APIs  [2nd,3rd] · medium
...
### 119. Consider Module-Scoped Code to Configure Deployment Environments  [2nd,3rd] · medium
...
### 120. Define a Root Exception to Insulate Callers from APIs  [2nd,3rd] · medium
...
### 121. Know How to Break Circular Dependencies  [2nd,3rd] · high
...
### 122. Consider warnings to Refactor and Migrate Usage  [2nd,3rd] · medium
...
### 123. Consider Static Analysis via typing to Obviate Bugs  [2nd,3rd] · medium
...
### 124. Prefer Open Source Projects for Bundling Python Programs over zipimport and zipapp  [3rd] · low
